 ...
 * @author Hien Hoang
 */
public class ListLocationsRes implements IResponse {
    ...
    public ListLocationsRes(IListLocationsResExec executor, String status, String message) {
    ...
    public ListLocationsRes(IListLocationsResExec executor, 
