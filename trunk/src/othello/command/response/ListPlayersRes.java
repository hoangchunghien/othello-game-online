 ...
 * @author Hien Hoang
 */
public class ListPlayersRes implements IResponse{
    ...
    public ListPlayersRes(IListPlayersResExec executor, String status, String message) {
        this.listPlayersResponseExecutor = executor;
        this.status = status;
        this.message = message;
    }
    
    public ListPlayersRes(IListPlayersResExec executor, String status, String message, List<Player> players) {
